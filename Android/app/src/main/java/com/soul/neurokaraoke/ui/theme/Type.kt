...
// TYPOGRAPHY SCALE
// ==========================================
// Exo 2 for display/headline/title (futuristic character)
// Inter for body/label (clean readability)
...
// Cyberpunk accent label — used for section headers: "NOW PLAYING", "YOUR LIBRARY", etc.
// Exo 2 Black + wide tracking for a HUD-like feel
val CyberLabelStyle = TextStyle(
    fontFamily = Exo2,
